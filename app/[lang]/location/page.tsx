...
export const metadata: Metadata = {
  ...
  description: "Visítanos en el corazón de Sevilla. Horarios, dirección y cómo llegar a nuestro restaurante.",
}
...
export default async function LocationPage({ params }: { params: { lang: Language } }) {
